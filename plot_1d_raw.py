...
def plot_training_metrics(train_losses, train_accuracies, train_f1_scores=None, save_path=None):
    """
    Plot training metrics (loss, accuracy, and F1-score) over epochs on a single plot.
    ...
    plt.title('CNN 1D Raw Audio - Training Metrics')
...
if __name__ == "__main__":
    ...
    plot_training_metrics(train_losses, train_accuracies, train_f1_scores, save_path="Figures/1d_raw.png")
