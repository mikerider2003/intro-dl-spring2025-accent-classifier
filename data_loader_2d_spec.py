...
class AccentSpectrogramDataset(Dataset):
    def __init__(self, file_paths, labels, sample_rate=16000, n_mels=128, n_fft=1024, hop_length=160, max_len=500):
...
class TestSpectrogramDataset(torch.utils.data.Dataset):
    def __init__(self, file_paths, sample_rate=16000, n_mels=128, n_fft=1024, hop_length=160, max_len=500):
        self.file_paths = file_paths
        self.sample_rate = sample_rate
        self.max_len = max_len
...
if __name__ == "__main__":
    ...
    print(f"Spectrogram saved as 'Figures/spectrogram_example.png'")